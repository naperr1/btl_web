        ...
        <div class="product">
            ...
            <form class="product__form" action="updateItem" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="itemID" name="itemID" value="${c.itemID}" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="costPrice" name="costPrice" value="${c.costPrice}" required />
                </div>
                <div class="form-group">
                  <label for="sellPrice">Sell Price</label>
                  <input type="text" id="sellPrice" name="sellPrice" value="${c.sellPrice}" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="categoryID" id="categoryID" value="${c.categoryID}">
